...
let validateForm = () => {
  ...
  if (!isValid) {
    ...
    message.textContent = 'Va rugam sa completati toate spatiile';
  ...
  if (password1El.value === password2El.value) {
    ...
    message.textContent = 'Asigura-te ca parola se potriveste';
    message.style.color = 'red';
    messageContainer.style.borderColor = 'red';
  ...
  if (isValid && passwordsMatch) {
    ...
    message.textContent = 'Te-ai inregistrat cu succes!';
